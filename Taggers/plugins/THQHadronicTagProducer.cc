...
private:
    ...
    bool use_MVAs_;
    double MVAThreshold_nrb_;
    double MVAThreshold_smh_;
    ...
    systLabel_( iConfig.getParameter<string> ( "SystLabel" ) )
{
    ...
    MVAThreshold_nrb_ = iConfig.getParameter<double>( "MVAThreshold_nrb" );
    MVAThreshold_smh_ = iConfig.getParameter<double>( "MVAThreshold_smh" );
...
void THQHadronicTagProducer::produce( Event &evt, const EventSetup & )
{
    ...
    for( unsigned int diphoIndex = 0; diphoIndex < diPhotons->size(); diphoIndex++ ) {
        ...
        // treatment for bjets
        //----------------------------------------------------------------------------------------------------
        // Note: not all jets are considered (loose wp)
        // Therefore, not suitable to determine 2nd Max b-tag scores from here
        ...
        bool has_resonable_reco = tprimeTagger_nrb->get_the_best_bjj_candidate(indices_bjj, jets, diphoton, bDeepCSV_jets, min_chi2_value_2x2);
        ...
        MVAvarList.chi2_bjet_btagScores_    = (has_resonable_reco && pass_eta_criteria_on_wjets) ? bDeepCSV_jets[indices_bjj[0]]    : -999;
        ...
        MVAvarList.chi2_wjet1_btagScores_   = (has_resonable_reco && pass_eta_criteria_on_wjets) ? bDeepCSV_jets[indices_bjj[1]]    : -999;
        ...
        MVAvarList.chi2_wjet2_btagScores_   = (has_resonable_reco && pass_eta_criteria_on_wjets) ? bDeepCSV_jets[indices_bjj[2]]    : -999;
        ...
        MVAvarList.jet1_btag_               = (n_jets_ >= 1) ? bDeepCSV_jets[0]              : -999;
        MVAvarList.jet2_eta_                = (n_jets_ >= 2) ? SelJetVect_PtSorted[1]->eta() : -999;
        MVAvarList.jet2_btag_               = (n_jets_ >= 2) ? bDeepCSV_jets[1]              : -999;
        MVAvarList.jet3_eta_                = (n_jets_ >= 3) ? SelJetVect_PtSorted[2]->eta() : -999;
        MVAvarList.jet3_btag_               = (n_jets_ >= 3) ? bDeepCSV_jets[2]              : -999;
        MVAvarList.jet4_eta_                = (n_jets_ >= 4) ? SelJetVect_PtSorted[3]->eta() : -999;
        MVAvarList.jet4_btag_               = (n_jets_ >= 4) ? bDeepCSV_jets[3]              : -999;
...
// MoreVariables{{{
        ...
        MyCheckVarList.bjet_btag_        = (has_resonable_reco && pass_eta_criteria_on_wjets) ? bDeepCSV_jets[indices_bjj[0]]    : -999;
        ...
        MyCheckVarList.wjet1_btag_       = (has_resonable_reco && pass_eta_criteria_on_wjets) ? bDeepCSV_jets[indices_bjj[1]]    : -999;
        ...
        MyCheckVarList.wjet2_btag_       = (has_resonable_reco && pass_eta_criteria_on_wjets) ? bDeepCSV_jets[indices_bjj[2]]    : -999;
        ...
        MyCheckVarList.jet1_btag_     =  (n_jets_ >= 1)  ? bDeepCSV_jets[0]                  : -999;
        ...
        MyCheckVarList.jet2_btag_     =  (n_jets_ >= 2)  ? bDeepCSV_jets[1]                  : -999;
        ...
        MyCheckVarList.jet3_btag_     =  (n_jets_ >= 3)  ? bDeepCSV_jets[2]                  : -999;
        ...
        MyCheckVarList.jet4_btag_     =  (n_jets_ >= 4)  ? bDeepCSV_jets[3]                  : -999;
        ...
        MyCheckVarList.jet5_btag_     =  (n_jets_ >= 5)  ? bDeepCSV_jets[4]                  : -999;
        ...
        MyCheckVarList.jet6_btag_     =  (n_jets_ >= 6)  ? bDeepCSV_jets[5]                  : -999;
        ...
        MyCheckVarList.jet7_btag_     =  (n_jets_ >= 7)  ? bDeepCSV_jets[6]                  : -999;
        ...
        MyCheckVarList.jet8_btag_     =  (n_jets_ >= 8)  ? bDeepCSV_jets[7]                  : -999;
        ...
        MyCheckVarList.jet9_btag_     =  (n_jets_ >= 9)  ? bDeepCSV_jets[8]                  : -999;
        ...
        MyCheckVarList.jet10_btag_    =  (n_jets_ >= 10) ? bDeepCSV_jets[9]                  : -999;
        ...
        MyCheckVarList.jet11_btag_    =  (n_jets_ >= 11) ? bDeepCSV_jets[10]                 : -999;
        ...
        MyCheckVarList.jet12_btag_    =  (n_jets_ >= 12) ? bDeepCSV_jets[11]                 : -999;
        ...
        MyCheckVarList.jet13_btag_    =  (n_jets_ >= 13) ? bDeepCSV_jets[12]                 : -999;
        ...
        MyCheckVarList.jet14_btag_    =  (n_jets_ >= 14) ? bDeepCSV_jets[13]                 : -999;
        ...
        MyCheckVarList.jet15_btag_    =  (n_jets_ >= 15) ? bDeepCSV_jets[14]                 : -999;
//}}}
        ...
        if(use_MVAs_) {
            ...
            //----------------------------------------------------------------------------------------------------
            // Maxime's condition (2021.10.16)
            //if(mva_value_nrb < 0.943) continue;
            //if(mva_value_smh < 0.800) continue;

            if(mva_value_nrb < MVAThreshold_nrb_) continue;
            if(mva_value_smh < MVAThreshold_smh_) continue;
            if( !(chi2_tprime_mass_ > 480. && chi2_tprime_mass_ < 800.) ) continue;
            if(evt.isRealData()) 
            {
                printf(">>> start my check (updated): ");
                printf("%s: %.10f\n" , "diphoton_mass_"           , dipho->mass()                );
                printf("%s: %.10f\n" , "diphoton_pt_"             , dipho->pt()                  );
                printf("%s: %.10f\n" , "chi2_tprime_mass_"        , chi2_tprime_mass_            );
        ...
        if( photonSelection ) {
            ...
            for( auto j : SelJetVect_PtSorted ) {
                ...
                thqhtags_obj.includeWeightsByLabel( *j , "JetBTagReshapeWeight");
                thqhtags_obj.includeWeightsByLabel( *j , "UnmatchedPUWeight");
            ...
            if(do_consistency_check)
            {
                ...
                std::cout << "[check] input parameter: ";
                std::cout << "JetIDLevel_ = " << JetIDLevel_ << ", ";
                std::cout << "bDiscriminator_[0] = " << bDiscriminator_[0] << ", ";
                std::cout << "bDiscriminator_[1] = " << bDiscriminator_[1] << ", ";
                std::cout << "bDiscriminator_[2] = " << bDiscriminator_[2] << ", ";
                std::cout << "MVAThreshold_nrb_ = " << MVAThreshold_nrb_ << ", ";
                std::cout << "MVAThreshold_smh_ = " << MVAThreshold_smh_ << std::endl;

                // # check for understanding
                if (true && systLabel_ == "") {
                    for (auto it = thqhtags_obj.weightListBegin() ; it != thqhtags_obj.weightListEnd(); it++) {
                        std::cout << "SCZ Weight Debug " << *it << " " << thqhtags_obj.weight(*it) << std::endl;
                    }
                }
