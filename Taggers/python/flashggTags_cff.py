...
btagDeepCSV_106X_UL17 = cms.vdouble(0.1355,0.4506,0.7738)
btagDeepJet_106X_UL17 = cms.vdouble(0.0532,0.3040,0.7476)

# https://twiki.cern.ch/twiki/bin/view/CMS/BtagRecommendation106XUL18#AK4_b_tagging
btagDeepCSV_106X_UL18 = cms.vdouble(0.1208,0.4168,0.7665)
btagDeepJet_106X_UL18 = cms.vdouble(0.0490,0.2783,0.7100)

jetID = 'Tight2017'
#jetID = self.metaConditions['THQHadronicTag']['jetID'] 
...
#                                       thqCatweightfile_ForNonPeakingBkg = cms.FileInPath("flashgg/Taggers/data/TMVA_THQLeptonicTag_tHq_Vs_NonPeakingBkg_BDT_16.weights.xml"),
                                        MVAweight_tHqVsttHBDT = cms.FileInPath("flashgg/Taggers/data/Tprime_search_training/THQLeptonicTag_TprimeM600_M700Vs_HiggsBkg_BDTG_RunII.weights.xml"),
                                        MVAweight_tHqVsNonHiggsBkg = cms.FileInPath("flashgg/Taggers/data/Tprime_search_training/THQLeptonicTag_TprimeM600_M700Vs_HiggsBkg_BDTG_RunII.weights.xml"),
                                        ...
                                        use_TprimeMass_cut = cms.bool(False),
                                        use_tHVsNonHiggsBDT = cms.bool(False),
                                        use_tthVstHDNN = cms.bool(False),
                                        use_tthVstHBDT = cms.bool(False),
                                        MVAThreshold_tHqVsttHDNN = cms.double(0.3),
                                        MVAThreshold_tHqVsttHBDT = cms.double(0.64),
                                        MVAThreshold_tHqVsNonHiggsBkg = cms.double(-0.5),
...
flashggTHQHadronicTag = cms.EDProducer("FlashggTHQHadronicTagProducer",
                                      ...
                                      # bDiscriminator = bDiscriminator94X, #bDiscriminator76X,
                                       ...
                                       #use_MVAs = cms.bool(True), # enable when producing workspace
                                       use_MVAs = cms.bool(False),
                                       MVAThreshold_nrb = cms.double(0.943),
                                       MVAThreshold_smh = cms.double(0.800),
                                       tprime_bdt_nrb_xmlfile = cms.FileInPath("flashgg/Taggers/data/Tprime_search_training/THQHadronicTag_TprimeM600_M700VsNRB_BDTG_RunII.xml"),
                                       tprime_bdt_smh_xmlfile = cms.FileInPath("flashgg/Taggers/data/Tprime_search_training/THQHadronicTag_TprimeM600_M700Vs_HiggsBkg_BDTG_RunII.xml"),
)
