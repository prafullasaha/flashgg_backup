...
#    "n_forwardjets := nForwardJets",
    ...
    "jet1_discr   := ? jets.size>0  ? bDeepCSV_jets.at(0)  : -999",
    "jet2_discr   := ? jets.size>1  ? bDeepCSV_jets.at(1)  : -999",
    "jet3_discr   := ? jets.size>2  ? bDeepCSV_jets.at(2)  : -999",
    "jet4_discr   := ? jets.size>3  ? bDeepCSV_jets.at(3)  : -999",
    "jet5_discr   := ? jets.size>4  ? bDeepCSV_jets.at(4)  : -999",
    "jet6_discr   := ? jets.size>5  ? bDeepCSV_jets.at(5)  : -999",
    "jet7_discr   := ? jets.size>6  ? bDeepCSV_jets.at(6)  : -999",
    "jet8_discr   := ? jets.size>7  ? bDeepCSV_jets.at(7)  : -999",
    "jet9_discr   := ? jets.size>8  ? bDeepCSV_jets.at(8)  : -999",
    "jet10_discr  := ? jets.size>9  ? bDeepCSV_jets.at(9)  : -999",
    "jet11_discr  := ? jets.size>10 ? bDeepCSV_jets.at(10) : -999",
    "jet12_discr  := ? jets.size>11 ? bDeepCSV_jets.at(11) : -999",
    "jet13_discr  := ? jets.size>12 ? bDeepCSV_jets.at(12) : -999",
    "jet14_discr  := ? jets.size>13 ? bDeepCSV_jets.at(13) : -999",
    "jet15_discr  := ? jets.size>14 ? bDeepCSV_jets.at(14) : -999",
    "jet1_deepjet   := ? jets.size>0  ? bDeepJet_jets.at(0)  : -999",
    "jet2_deepjet   := ? jets.size>1  ? bDeepJet_jets.at(1)  : -999",
    "jet3_deepjet   := ? jets.size>2  ? bDeepJet_jets.at(2)  : -999",
    "jet4_deepjet   := ? jets.size>3  ? bDeepJet_jets.at(3)  : -999",
    "jet5_deepjet   := ? jets.size>4  ? bDeepJet_jets.at(4)  : -999",
    "jet6_deepjet   := ? jets.size>5  ? bDeepJet_jets.at(5)  : -999",
    "jet7_deepjet   := ? jets.size>6  ? bDeepJet_jets.at(6)  : -999",
    "jet8_deepjet   := ? jets.size>7  ? bDeepJet_jets.at(7)  : -999",
    "jet9_deepjet   := ? jets.size>8  ? bDeepJet_jets.at(8)  : -999",
    "jet10_deepjet  := ? jets.size>9  ? bDeepJet_jets.at(9)  : -999",
    "jet11_deepjet  := ? jets.size>10 ? bDeepJet_jets.at(10) : -999",
    "jet12_deepjet  := ? jets.size>11 ? bDeepJet_jets.at(11) : -999",
    "jet13_deepjet  := ? jets.size>12 ? bDeepJet_jets.at(12) : -999",
    "jet14_deepjet  := ? jets.size>13 ? bDeepJet_jets.at(13) : -999",
    "jet15_deepjet  := ? jets.size>14 ? bDeepJet_jets.at(14) : -999",
