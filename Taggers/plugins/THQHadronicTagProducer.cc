...
//------------------------------------ Likelihood and MVA -----------------------------------------//
        ...
        if(use_MVAs_) {
            ...
            tprimeTagger_nrb->addDiPho_pt(dipho->pt());
            ...
            tprimeTagger_smh->addDiPho_pt(dipho->pt());
        ...
        if(do_consistency_check)
        {
            ...
            printf("%s: %8.7f, "  , "diphoton_mass_                                     "             , dipho->mass()                                                                );
            printf("%s: %8.7f, \n"  , "diphoton_pt_                                     "               , dipho->pt()                                                                  );
            cout<<                    "[CHECK in COUT]diphoton_pt in Producer           =" <<dipho->pt()<<endl;
            cout<<                    "[CHECK in COUT]diphoton_mass in Producer           =" <<dipho->mass()<<endl;
...
//        if(mva_value_nrb < 0.58) continue;
//        if(mva_value_smh < 0.814) continue;
