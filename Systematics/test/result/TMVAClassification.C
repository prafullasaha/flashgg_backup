...
//   TString fname = "/home/prafulla/result_higheta/thq_tth_test_muon.root";
     TString fname = "output_THQ_comb.root";

   if (!gSystem->AccessPathName( fname )) {
    input = TFile::Open( fname ); // check if file in local directory exists
    input1 = TFile::Open("output_TTHJet_comb.root");
//    input1 = TFile::Open("/home/prafulla/result_higheta/thq_tth_test_muon.root");
   }
   else {
   ...
   TTree *signalTree     = (TTree*)input->Get("tagsDumper/trees/THQ_13TeV_THQLeptonicTag");
   TTree *background     = (TTree*)input1->Get("tagsDumper/trees/Bkg_13TeV_THQLeptonicTag");
...
//   dataloader->AddVariable( "var4",                "Variable 4", "units", 'F' );
     ...
     dataloader->AddVariable( "dipho_pt", "dipho_pt", "units", 'F' );
