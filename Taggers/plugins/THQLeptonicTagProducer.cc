...
//          thqLeptonicMva_->AddVariable( "dEta_leptonfwdjet",     &dEta_leptonfwdjet_ );
...
//cout<<"SelJetVect_EtaSorted[0]           ="<<SelJetVect_EtaSorted[0]->bDiscriminator("pfDeepCSVJetTags:probb") + SelJetVect_EtaSorted[0]->bDiscriminator("pfDeepCSVJetTags:probbb")<<endl;
